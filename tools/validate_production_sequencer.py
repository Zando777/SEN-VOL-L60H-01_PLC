...
required = (
    "#Req_AMRelays := FALSE;",
    "#Req_Ign50 := FALSE;",
    "#Req_EstopBrakeCh1Apply := #AutoMode OR NOT #ModeInputValid;",
    "#Req_EstopBrakeCh2Apply := #AutoMode OR NOT #ModeInputValid;",
    "#Req_ParkUnlock := TRUE;",
    ...
    "#ST_MANUAL_HANDOVER:",
    "#ST_MODE_INVALID:",
    "#faultCodeLatched := #F_MODE_INVALID;",
    "#ManualHandoverActive := TRUE;",
    "#ModeFaultActive := TRUE;",
    "ELSIF NOT #ModeInputValid THEN",
    "ELSIF NOT #AutoMode THEN",
    "#State := #stateMachine;",
    "#FaultCode := #faultCodeLatched;",
    "#CrankAttempts := #crankAttemptsLatched;",
    "#ST_BRAKE_CH1_APPLY:",
    "#Shuttle1_bar <= 5.0",
    "#Shuttle1_bar >= 30.0",
    "#Shuttle1_bar <= 50.0",
